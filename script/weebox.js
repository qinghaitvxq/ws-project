		...
		this.initBox = function() {
			...
			switch(self.options.type) {
				...
				html =  '<div class="weedialog">' +
						...
						'					<input type="button" class="dialog-ok" id="dialog-ok" value="确定">' +
						'					<input type="button" class="dialog-cancel" id="dialog-cancel" value="取消">' +
						'				</div>' +
						'   </div>' +
				...
				html =  '<div class="weedialog">' +
						...
						'		<div class="dialog-tc">' +
						'			<div class="dialog-tc1"></div>' +
						'			<div class="dialog-tc2"><a href="javascript:;" onclick="return false" title="关闭" ></a><span class="dialog-title"></span></div>' +
						'		</div>' +
						'		<div class="dialog-tr"></div>' +
						'	</div>' +
						'   <div>' +
